package hs.kr.entrydsm.feed.domain.notice.adapter.`in`.web
 ...
 *
 * @property createNoticeUseCase 공지사항 생성 유스케이스
 * @property updateNoticeUseCase 공지사항 수정 유스케이스
 * @property deleteNoticeUseCase 공지사항 삭제 유스케이스
 * @property queryDetailsNoticeUseCase 공지사항 상세 정보 조회 유스케이스
 * @property queryNoticeTitleUseCase 공지사항 제목 목록 조회 유스케이스
 * @property uploadNoticeImageUseCase 공지사항 이미지 업로드 유스케이스
 * @property queryListNoticeListByTypeUseCase 공지사항 유형별 목록 조회 유스케이스
 */
@RestController
